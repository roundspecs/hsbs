      ...
      <div className="max-w-md mx-auto text-center">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200 p-8">
          ...
          <div className="space-y-3">
            <Button
              onClick={() => router.push("/")}
              className="w-full h-12 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium rounded-xl transition-all duration-200"
            >
